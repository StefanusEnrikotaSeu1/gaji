...
@section('content_header')
    ...
    <a href="{{ route('grafik.jabatan') }}" class="btn btn-danger btn-md " target="_blank"> Grafik Jabatan</a>
    <a href="{{ route('export.excel') }}" class="btn btn-info btn-md " target="_blank"> Export Excel</a>
@stop
